...
export function Audit() {
    ...
    return (_jsxs("div", { children: [_jsx("div", { className: "page-header", children: _jsxs("div", { children: [_jsx("div", { className: "page-title", children: "Audit Log" }), _jsx("div", { className: "page-subtitle", children: data ? `${data.total} total events` : 'Searchable event history' })] }) }), _jsxs("div", { className: "card", style: {
                    ...
                    flexWrap: 'wrap',
                                    ...
                                    setPage(0);
                                } })] }), _jsx("button", { className: "btn", onClick: refresh, style: { marginBottom: '0.15rem' }, children: "Refresh" })] }), loading ? (_jsx(LoadingState, {})) : error ? (_jsx(ErrorState, { message: error, onRetry: refresh })) : !data || data.events.length === 0 ? (_jsx("div", { className: "card", children: _jsx("div", { className: "empty-state", children: "No audit events match your filters" }) })) : (_jsxs(_Fragment, { children: [_jsx("div", { className: "card", style: { padding: 0, overflow: 'auto' }, children: _jsxs("table", { className: "data-table", children: [_jsx("thead", { children: _jsxs("tr", { children: [_jsx("th", { children: "Timestamp" }), _jsx("th", { children: "Incident" }), _jsx("th", { children: "Agent" }), _jsx("th", { children: "Action" }), _jsx("th", { children: "Status" }), _jsx("th", { children: "Detail" })] }) }), _jsx("tbody", { children: data.events.map((ev, i) => (_jsxs("tr", { onClick: () => {
                                            ...
                                            window.dispatchEvent(new PopStateEvent('popstate'));
                                                    ...
                                                    fontSize: '0.75rem',
                                                    whiteSpace: 'nowrap',
                                                }, children: new Date(ev.created_at).toLocaleString() }), _jsx("td", { style: {
                                                    fontFamily: 'var(--font-mono)',
                                                    fontSize: '0.8rem',
                                                    color: 'var(--accent)',
