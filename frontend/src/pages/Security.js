...
export function Security() {
    ...
    return (_jsxs("div", { children: [_jsx("div", { className: "page-header", children: _jsxs("div", { children: [_jsx("div", { className: "page-title", children: "Security Authority Model" }), _jsx("div", { className: "page-subtitle", children: "Observational view of the authorization hierarchy" })] }) }), _jsxs("div", { className: "card", style: { marginBottom: '1.5rem' }, children: [_jsx("div", { className: "card-header", children: "Plan Actions" }), _jsx("p", { style: { fontSize: '0.85rem', color: 'var(--text-secondary)', marginBottom: '0.75rem' }, children: "Top-level actions defined in the root plan that agents may be delegated to execute." }), data.plan_actions.length === 0 ? (_jsx("div", { className: "empty-state", children: "No plan actions defined" })) : (_jsx("div", { style: { display: 'flex', flexDirection: 'column', gap: '0.4rem' }, children: data.plan_actions.map((action, i) => (_jsxs("div", { style: {
                                ...
                                fontSize: '0.85rem',
                            }, children: [_jsxs("span", { style: { color: 'var(--accent)', fontWeight: 600 }, children: [i + 1, "."] }), action] }, i))) }))] }), data.delegations.length === 0 ? (_jsx("div", { className: "card", children: _jsx("div", { className: "empty-state", children: "No delegation entries configured" }) })) : (_jsx("div", { style: { display: 'flex', flexDirection: 'column', gap: '0.75rem' }, children: data.delegations.map((entry, i) => (_jsxs("div", { className: "card", style: {
                        borderLeft: `3px solid ${i === 0 ? 'var(--accent)' : i === 1 ? 'var(--green)' : 'var(--purple)'}`,
                                        ...
                                        marginBottom: '0.3rem',
                                            ...
                                            padding: '0.2rem 0.5rem',
                                            color: 'var(--green)',
                                        }, children: action }, ai))) })] })] }, i))) })), data.note && (_jsxs("div", { className: "card", style: {
                    marginTop: '1.5rem',
                    borderColor: 'rgba(245,166,35,0.3)',
                    background: 'rgba(245,166,35,0.03)',
                }, children: [_jsx("div", { className: "card-header", style: { color: 'var(--yellow)' }, children: "Note" }), _jsx("p", { style: { fontSize: '0.85rem', color: 'var(--text-secondary)' }, children: data.note })] }))] }));
}
